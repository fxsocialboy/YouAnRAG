...
```json
{
  ...
  "chunk_sparse": 0.24,
  "chunk_hybrid": 0.2,
  "hybrid_minus_dense_doc": 0.04,
  "filter_pass_ratio": 1.0,
  "packed_nonempty_ratio": 1.0,
  "avg_packed_token_ratio": 0.8608,
  "avg_latency_ms": 646.54
}
```
...
```json
{
  ...
  "chunk_sparse": 0.6,
  "chunk_hybrid": 0.6,
  "hybrid_minus_dense_doc": 0.1,
  "filter_pass_ratio": 1.0,
  "packed_nonempty_ratio": 1.0,
  "avg_packed_token_ratio": 0.8972,
  "avg_latency_ms": 528.67
}
```
...
- `k006` / `省级减灾委员会 职责`：dense=0，hybrid=1，Top-3=['吉林省自然灾害救助应急预案.md', '湖北省自然灾害救助应急预案的通知.md', '陕西省.md']
